...
public class OCamlRenameRecordFieldOrConstructorProcessor extends RenamePsiElementProcessor
{
			...
			String> conflicts)
	{
		...
		final OCamlElement parent = element instanceof OCamlRecordFieldDefinition ? OCamlPsiUtil.getParent(element) : OCamlPsiUtil.getParentOfType
				(element, OCamlVariantTypeDefinition.class);
		if(parent == null)
		{
			return;
		}
		...
		{
			if(OCamlPsiUtil.isParentOf(child, element))
			{
				continue;
			}
