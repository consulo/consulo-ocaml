...
class OCamlSourcesPathStep extends ModuleWizardStep
{
	...
	public JComponent getComponent()
	{
		...
		panel.add(myRbCreateSource, new GridBagConstraints(0, GridBagConstraints.RELATIVE, 1, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST,
		...
		panel.add(srcPathLabel, new GridBagConstraints(0, GridBagConstraints.RELATIVE, 1, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST,
				GridBagConstraints.HORIZONTAL, new Insets(8, 30, 0, 0), 0, 0));
		...
		panel.add(fieldPanel, new GridBagConstraints(0, GridBagConstraints.RELATIVE, 1, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST,
				GridBagConstraints.HORIZONTAL, new Insets(8, 30, 0, 10), 0, 0));

		myRbNoSource = new JRadioButton("Do not create source directory", !myBuilder.isShouldCreateSourcesDir());
		panel.add(myRbNoSource, new GridBagConstraints(0, GridBagConstraints.RELATIVE, 1, 1, 1.0, 1.0, GridBagConstraints.NORTHWEST,
				GridBagConstraints.NONE, new Insets(8, 10, 0, 10), 0, 0));

		final JLabel fullPathLabel = new JLabel("The following directory will be marked as a source directory:");
		panel.add(fullPathLabel, new GridBagConstraints(0, GridBagConstraints.RELATIVE, 1, 1, 1.0, 0.0, GridBagConstraints.SOUTHWEST,
				GridBagConstraints.NONE, new Insets(8, 10, 0, 10), 0, 0));
		...
		panel.add(myTfFullPath, new GridBagConstraints(0, GridBagConstraints.RELATIVE, 1, 1, 1.0, 0.0, GridBagConstraints.SOUTHWEST,
	...
	public boolean validate() throws ConfigurationException
	{
		...
		if(myRbCreateSource.isSelected())
		{
			...
			if(relativePath.length() == 0)
			{
				...
				final String text = "Relative path to sources is empty.\nWould you like to mark the module content root" + contentRoot + "as a source " +
						"directory?";
				final int answer = Messages.showDialog(myTfSourceDirectoryName, text, "Mark source directory", new String[]{
						"Mark",
						"Do Not Mark",
			...
			if(sourceDirectoryPath != null)
			{
				...
				try
				{
					...
					{
						Messages.showErrorDialog(myTfSourceDirectoryName, "Source directory should be under module content root directory",
