...
public class OCamlModuleType extends ModuleType<OCamlModuleBuilder>
{
	...
	@Override
	public ModuleWizardStep[] createWizardSteps(final WizardContext wizardContext, final OCamlModuleBuilder moduleBuilder,
			final ModulesProvider modulesProvider)
	{
		...
		final ModuleWizardStep supportForFrameworksStep = ProjectWizardStepFactory.getInstance().createSupportForFrameworksStep(wizardContext,
				moduleBuilder);
