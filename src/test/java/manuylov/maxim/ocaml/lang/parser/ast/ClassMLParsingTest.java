...
public class ClassMLParsingTest extends BaseClassParsingTest
{
	...
	public void testSeveralClassBindings() throws Exception
	{
		...
		doTest("class class1 = class0 and virtual class1 = class0 and ['a, 'b, 'c] class1 = class0 and virtual ['a, 'b, 'c] class1 = class0 and class1 ~label1 ~label2 = class0 and class1 : class2 = " +
				"class0 and class1 ~label1 ~label2 : class2 = class0 and class1 ~label1 ~label2: x = class0", myTree.getStringRepresentation());
	}
