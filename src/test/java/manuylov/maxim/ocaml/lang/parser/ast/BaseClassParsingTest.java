...
public abstract class BaseClassParsingTest extends ParsingTestCase
{
	...
	public void testObjectEndClassBodyType() throws Exception
	{
		...
		doTest("class type class1 = object " + "inherit class0 " + "val x : int " + "val mutable x : int " + "val virtual x : int " + "val mutable virtual x : int " + "method m : 'a . int " +
				"method private m : 'a . int " + "method virtual m : 'a . int " + "method private virtual m : 'a . int " + "constraint 'a = int " + "end", myTree.getStringRepresentation());
		...
		doTest("class type class1 = object (int) " + "inherit class0 " + "val x : int " + "val mutable x : int " + "val virtual x : int " + "val mutable virtual x : int " + "method m : 'a . int " +
				"method private m : 'a . int " + "method virtual m : 'a . int " + "method private virtual m : 'a . int " + "constraint 'a = int " + "end", myTree.getStringRepresentation());
	}
