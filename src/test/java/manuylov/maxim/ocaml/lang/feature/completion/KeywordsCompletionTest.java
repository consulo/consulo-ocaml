...
public abstract class KeywordsCompletionTest extends CompletionTestCase
{
	...
	{
		setVariants(BEGIN_KEYWORD, IF_KEYWORD, WHILE_KEYWORD, FOR_KEYWORD, MATCH_KEYWORD, FUNCTION_KEYWORD, FUN_KEYWORD, TRY_KEYWORD, NEW_KEYWORD, ASSERT_KEYWORD, LAZY_KEYWORD, TRUE_KEYWORD,
				FALSE_KEYWORD);
