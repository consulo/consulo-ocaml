...
public abstract class BaseLexerTest extends LexerTestCase
{
	...
	public void testComments()
	{
		...
		doTest("( * )", token(OCamlTokenTypes.LPAR, "("), token(OCamlTokenTypes.WHITE_SPACE, " "), token(OCamlTokenTypes.MULT, "*"), token(OCamlTokenTypes.WHITE_SPACE, " "), token(OCamlTokenTypes
				.RPAR, ")"));
		doTest("(* *) *)", token(OCamlTokenTypes.COMMENT_BEGIN, "(*"), token(OCamlTokenTypes.COMMENT, " "), token(OCamlTokenTypes.COMMENT_END, "*)"), token(OCamlTokenTypes.WHITE_SPACE, " "), token
				(OCamlTokenTypes.MULT, "*"), token(OCamlTokenTypes.RPAR, ")"));
		doTest("(* (* *) *)", token(OCamlTokenTypes.COMMENT_BEGIN, "(*"), token(OCamlTokenTypes.COMMENT, " "), token(OCamlTokenTypes.COMMENT_BEGIN, "(*"), token(OCamlTokenTypes.COMMENT, " "), token
				(OCamlTokenTypes.COMMENT_END, "*)"), token(OCamlTokenTypes.COMMENT, " "), token(OCamlTokenTypes.COMMENT_END, "*)"));
