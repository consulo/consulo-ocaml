...
{
	public OCamlArgumentImpl(@Nonnull final ASTNode node)
	{
		super(node);
	}
	...
	{
		return OCamlPsiUtil.endsCorrectlyWith(this, OCamlLabelName.class) || OCamlPsiUtil.endsCorrectlyWith(this, OCamlExpression.class);
	}
