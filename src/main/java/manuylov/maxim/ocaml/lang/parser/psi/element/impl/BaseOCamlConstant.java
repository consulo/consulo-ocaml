...
abstract class BaseOCamlConstant extends BaseOCamlElement implements OCamlConstant
{
	...
	public boolean endsCorrectly()
	{
		...
		return type == OCamlTokenTypes.ACCENT && OCamlPsiUtil.endsCorrectlyWith(this, OCamlTagName.class) || type == OCamlTokenTypes.LPAR && OCamlPsiUtil
				.endsWith(this, OCamlTokenTypes.RPAR) || type != OCamlTokenTypes.ACCENT && type != OCamlTokenTypes.LPAR;
	}
}
